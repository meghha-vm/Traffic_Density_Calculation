...
public class viewApprovedPolice extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_approved_police);
        lv=(ListView) findViewById(R.id.lv);

        sh=getSharedPreferences("", Context.MODE_PRIVATE);
        url="http://"+sh.getString("ip","")+":5000/viewApprovePolice";
    ...
    private void ViewApprovedUsers(){
        RequestQueue rq = Volley.newRequestQueue(viewApprovedPolice.this);
