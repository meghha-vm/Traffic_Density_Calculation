...
public class ambulanceView extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url="http://"+sh.getString("ip","")+":5000/aView";
    ...
    private void UserApproval(){
        RequestQueue rq = Volley.newRequestQueue(ambulanceView.this);
